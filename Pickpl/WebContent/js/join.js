Kakao.init('218e8fedd2cb6770e181a0e8a08311e7');
Kakao.isInitialized();

// 네이버 로그인

function naverLogin() {
	naver = "https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=oe5P8LDPfOxlIXlTl7gr&state=STATE_STRING&redirect_uri=http://localhost:9090/Pickpl/naverCallback.html"
...
////			callbackUrl: "https://localhost:9090/Pickpl/naverCallback.html",
//			isPopup: true,
